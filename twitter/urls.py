...
urlpatterns = [
    ...
    path('user/<str:username>/tweets',views.userTweets),
    path('user/<str:username>/followers',views.profileFollowlist),
    path('user/<str:username>/following',views.profileFollowinglist),
